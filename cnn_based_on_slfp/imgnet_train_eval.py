...
def Initializes_command_data_model():
  ...
  if cfg.net == "mobilenetv1":
    ...
    # pretrain_dir = './ckpt/imgnet-1k/20241023_mobilenet_imgnet_1e6_batch_size_68.068.pth'    # val-8bits:68.068%  
    # pretrain_dir = './ckpt/imgnet-1k/20241023_mobilenet_imgnet_1e6_batch_size_68.068.pth'    # val-8bits:68.068%
...
if __name__ == '__main__':  
    ...
    if (cfg.pre_reference == True):
      ...
      put_scale_factor_batch_size_txt(max_abs_layer_inputs_list, max_abs_layer_outputs_list, max_abs_layer_weights_list, weight_folder_path, input_folder_path)
