...
def Initializes_command_data_model():
  ...
  if cfg.net == "mobilenet":
    ...
    # pretrain_dir = './ckpt/cifar-100/mobilenet_20241019_0.00001_batchsize_60.85.pth'   # slfp
...
if __name__ == '__main__':
  ...
  if cfg.pre_reference:
    ...
    input_folder_path = '/workspaces/pytorch-dev/Cnn_Based_On_Slfp/max_act_wgt/cifar/batch_size_input_max.txt'
    ...
    #------- 1. every batch size = Set of channels , Ignore the first layer of standard convolution-------#
    weight_folder_path = '/workspaces/pytorch-dev/Cnn_Based_On_Slfp/max_act_wgt/cifar/batch_size_weight_max.txt'
